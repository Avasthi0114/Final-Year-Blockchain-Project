...
//         // Here you can check the type of file if needed
//         const fileType = 'application/pdf'; // Example, can be determined dynamically based on file metadata

//         // Return the buffer (optionally as a base64 string if needed for frontend)
//         return { status: "success", fileBuffer: fileBuffer.toString('base64'), fileType: fileType }; 
//     } catch (error) {
