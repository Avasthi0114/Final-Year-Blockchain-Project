...
// // Set a predefined password for simplicity (you can make this dynamic)
...
// app.post('/getFile', async (req, res) => {
//     try {
//         const { evidenceCID, password } = req.body;

//         // Check the password
//         if (password !== PASSWORD) {
//             return res.json({ error: "Incorrect password. Access denied." });
//         }

//         const data = await getFile(evidenceCID);

//         // Send the base64 encoded buffer and fileType to the client
//         res.send({ fileBuffer: data.fileBuffer, fileType: data.fileType });
//     } catch (error) {
//         console.error('Error getting file:', error);
//         res.status(500).send(error);
//     }
