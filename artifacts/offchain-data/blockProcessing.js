...
//                             await mongodb.collection('fir-channel_fabcar').insertOne({
...
//                     // mongodb.collection('fir-channel_fabcar_history').insertOne({ data: JSON.parse(keyvalue) }, () => {
//                     //     console.log("data inserted")
//                     // })
//                 }
//             } catch (error) {
                ...
                for (var sequence in values) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            await mongodb.collection('fir-channel_FIRManagement').insertOne({
                                _id: keyvalue.key, data: JSON.parse(
                                    keyvalue.value
                                )
                            }, () => {
                    ...
                    // mongodb.collection('fir-channel_FIRManagement_history').insertOne({ data: JSON.parse(keyvalue) }, () => {
                    //     console.log("data inserted")
                    // })
                }
            } catch (error) {
