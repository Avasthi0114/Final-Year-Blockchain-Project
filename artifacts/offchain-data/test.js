...
//     db.collection('fir-channel_fabcar').insertOne({_id:111, test:"test data"},()=>{
...
//     // database.collection('fir-channel_fabcar').insertOne({test:"test data"},()=>{
//     //     console.log("data inserted")
//     // })
// }
...
const connect =async ()=>{
    ...
    db.collection('fir-channel_FIRManagement').insertOne({_id:111, test:"test data"},()=>{
        console.log("data inserted")
    })
}
...
const addData= (database)=>{
    ...
    // database.collection('fir-channel_FIRManagement').insertOne({test:"test data"},()=>{
    //     console.log("data inserted")
    // })
}
