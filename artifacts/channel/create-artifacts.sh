...
rm -rf ./crypto-config
rm genesis.block fir-channel.tx
# rm genesis.block fir-channel.tx
...
# channel name defaults to "fir-channel"
...
configtxgen -profile BasicChannel -configPath . -outputCreateChannelTx ./fir-channel.tx -channelID $CHANNEL_NAME
