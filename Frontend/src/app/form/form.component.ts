...
//               if (ipfsResponse.folderCID) {
//                 // Call the backend to process evidences
//                 this.httpService.processEvidences(ipfsResponse.folderCID).subscribe(
//                   (folderResponse: any) => {
//                     console.log('Folder updated successfully:', folderResponse);
//                   },
//                   (folderError: any) => {
...
//                 );
//               } else {
//                 console.error('Folder CID is missing from IPFS response.');
//               }
