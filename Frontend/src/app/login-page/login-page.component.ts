...
//             this.emailService.setEmail(LoginFormData.Email); // Store the email
//           } else {
...
//           // Check the rank from the response
//         const officerRank = response.rank;
//          console.log("officerRank: "+officerRank);
//         if (officerRank === 'PI') {
//           this.router.navigate(['/eFIR']); // Route for PI rank
//         } else {
//           this.router.navigate(['/policedash']); // Route for other ranks
//         }
//         },
//         (error) => {
//           this.ngxService.stop();
    ...
    if (this.LoginForm.valid) {
      ...
      this.httpService.LoginPolice(data).subscribe(
        ...
        const officerRank = response.rank;
         console.log("officerRank: "+officerRank);
        if (officerRank === 'PI') {
          this.router.navigate(['/pidashboard']); // Route for PI rank
        } else {
          this.router.navigate(['/policedash']); // Route for other ranks
        }
        },
